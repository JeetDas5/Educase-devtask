...
const Home = () => {
  ...
  return (
    <div className="max-h-screen bg-gradient-to-br from-indigo-100 via-purple-100 to-blue-100 overflow-hidden relative transition-all duration-700 ease-in-out">
